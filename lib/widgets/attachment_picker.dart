...
class AttachmentPicker extends StatelessWidget {
  ...
  static Future<void> show(BuildContext context, AgentColors nc, Function(File, String) onPicked) {
      ...
      child: Column(
        ...
        children: [
          ...
          Padding(
            ...
            child: Text('添加附件', style: TextStyle(fontSize: 13, color: nc.textSecondary, fontWeight: FontWeight.w500)),
          ),
          Container(
  ...
  Future<void> _pickFile(BuildContext context, FileType type, String category) async {
      ...
      child: InkWell(
        ...
        child: Padding(
          ...
          child: Row(children: [
            ...
            Expanded(
              child: Text(label, style: TextStyle(fontSize: 15, color: nc.textPrimary)),
            ),
